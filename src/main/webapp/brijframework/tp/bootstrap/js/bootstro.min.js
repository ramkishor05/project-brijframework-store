$(document).ready(function () {
  (function (e, t, n) {
    ...
    var s = [];
    var o = null;
    var u = {nextButtonText: "Next »", prevButtonText: "« Prev", finishButtonText: '<i class="icon-ok"></i> Ok I got it, get back to the site', stopOnBackdropClick: true, stopOnEsc: true, margin: 100};
    var a;
    ...
    e.start = function (n, r) {
      ...
      if (typeof a.url != "undefined") {
        t.ajax({url: a.url, success: function (r) {
          if (r.success) {
            var i = r.result;
            var s = [];
