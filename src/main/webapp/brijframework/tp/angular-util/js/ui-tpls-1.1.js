 ...
 * http://angular-uib.github.io/bootstrap/

 * Version: 1.1.2 - 2016-02-01
 * License: MIT
 */angular.module("uib.bootstrap", ["uib.bootstrap.tpls", "uib.bootstrap.collapse","uib.bootstrap.accordion","uib.bootstrap.alert","uib.bootstrap.buttons","uib.bootstrap.carousel","uib.bootstrap.dateparser","uib.bootstrap.isClass","uib.bootstrap.position","uib.bootstrap.datepicker","uib.bootstrap.debounce","uib.bootstrap.dropdown","uib.bootstrap.stackedMap","uib.bootstrap.modal","uib.bootstrap.paging","uib.bootstrap.pager","uib.bootstrap.pagination","uib.bootstrap.tooltip","uib.bootstrap.popover","uib.bootstrap.progressbar","uib.bootstrap.rating","uib.bootstrap.tabs","uib.bootstrap.timepicker","uib.bootstrap.typeahead"]);
angular.module("uib.bootstrap.tpls", ["uib/template/accordion/accordion-group.html","uib/template/accordion/accordion.html","uib/template/alert/alert.html","uib/template/carousel/carousel.html","uib/template/carousel/slide.html","uib/template/datepicker/datepicker.html","uib/template/datepicker/day.html","uib/template/datepicker/month.html","uib/template/datepicker/popup.html","uib/template/datepicker/year.html","uib/template/modal/backdrop.html","uib/template/modal/window.html","uib/template/pager/pager.html","uib/template/pagination/pagination.html","uib/template/tooltip/tooltip-html-popup.html","uib/template/tooltip/tooltip-popup.html","uib/template/tooltip/tooltip-template-popup.html","uib/template/popover/popover-html.html","uib/template/popover/popover-template.html","uib/template/popover/popover.html","uib/template/progressbar/bar.html","uib/template/progressbar/progress.html","uib/template/progressbar/progressbar.html","uib/template/rating/rating.html","uib/template/tabs/tab.html","uib/template/tabs/tabset.html","uib/template/timepicker/timepicker.html","uib/template/typeahead/typeahead-match.html","uib/template/typeahead/typeahead-popup.html"]);
angular.module('uib.bootstrap.collapse', [])
...
angular.module('uib.bootstrap.accordion', ['uib.bootstrap.collapse'])
...
angular.module('uib.bootstrap.alert', [])
...
angular.module('uib.bootstrap.buttons', [])
...
angular.module('uib.bootstrap.carousel', [])
...
angular.module('uib.bootstrap.dateparser', [])
...
// at most one element.
angular.module('uib.bootstrap.isClass', [])
...
angular.module('uib.bootstrap.position', [])
...
angular.module('uib.bootstrap.datepicker', ['uib.bootstrap.dateparser', 'uib.bootstrap.isClass', 'uib.bootstrap.position'])
...
angular.module('uib.bootstrap.debounce', [])
		/**
...
angular.module('uib.bootstrap.dropdown', ['uib.bootstrap.position'])
...
angular.module('uib.bootstrap.stackedMap', [])
		/**
...
angular.module('uib.bootstrap.modal', ['uib.bootstrap.stackedMap'])
		/**
...
angular.module('uib.bootstrap.pager', ['uib.bootstrap.paging'])
 ...
 */
angular.module('uib.bootstrap.tooltip', ['uib.bootstrap.position', 'uib.bootstrap.stackedMap'])
		...
		.provider('$uibTooltip', function() {
			 ...
			 * application.
			 *
			 *   var app = angular.module( 'App', ['uib.bootstrap.tooltip'], function( $tooltipProvider ) {
								...
								var positionTooltip = function() {
									...
									if (!positionTimeout) {
										positionTimeout = $timeout(function() {
											...
											tooltip.css({ top: ttPosition.top+10 + 'px', left: ttPosition.left + 'px', visibility: 'visible' });
 ...
 */
angular.module('uib.bootstrap.popover', ['uib.bootstrap.tooltip'])
...
angular.module('uib.bootstrap.progressbar', [])
...
angular.module('uib.bootstrap.rating', [])
...
angular.module('uib.bootstrap.tabs', [])
...
angular.module('uib.bootstrap.timepicker', [])
...
angular.module('uib.bootstrap.typeahead', ['uib.bootstrap.debounce', 'uib.bootstrap.position'])
...
angular.module('uib.bootstrap.carousel').run(function() {!angular.$$csp().noInlineStyle && angular.element(document).find('head').prepend('<style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style>'); });
angular.module('uib.bootstrap.datepicker').run(function() {!angular.$$csp().noInlineStyle && angular.element(document).find('head').prepend('<style type="text/css">.uib-datepicker .uib-title{width:100%;}.uib-day button,.uib-month button,.uib-year button{min-width:100%;}.uib-datepicker-popup.dropdown-menu{display:block;}.uib-button-bar{padding:10px 9px 2px;}</style>'); });
angular.module('uib.bootstrap.timepicker').run(function() {!angular.$$csp().noInlineStyle && angular.element(document).find('head').prepend('<style type="text/css">.uib-time input{width:50px;}</style>'); });
angular.module('uib.bootstrap.typeahead').run(function() {!angular.$$csp().noInlineStyle && angular.element(document).find('head').prepend('<style type="text/css">[uib-typeahead-popup].dropdown-menu{display:block;}</style>'); });