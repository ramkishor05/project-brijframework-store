...
(function(context, factory) {
  ...
  utils = {
    ...
    getStepTarget: function(step) {
      ...
      if(step.isDomElement){
    	  step.target = eval(step.target);
      }
...
$(window).click(function(e) {   
	if( !$(e.target).hasClass('hopscotch-bubble-container') && !$(e.target).hasClass('alta-hopscotch') && !$(e.target).hasClass('hopscotch-bubble-number') &&  !$(e.target).hasClass('hopscotch-title') &&  !$(e.target).hasClass('hopscotch-content') &&  !$(e.target).hasClass('hopscotch-bubble-close') &&  !$(e.target).hasClass('hopscotch-nav-button') &&  !$(e.target).hasClass('fa-question-circle') )
	{
		$(".hopscotch-bubble").css({
			  'left': '-400px'
			 });
