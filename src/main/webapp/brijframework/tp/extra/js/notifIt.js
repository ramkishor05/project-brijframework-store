...
function notif(config) {
  ...
  time = config.time == undefined?5000:config.time;
  // General position
  if (config.position) {
  ...
  var div = "<div id='ui_notifIt' onmouseenter='prevent_dismiss()' onmouseleave='notifit_dismiss()'><p>" + ((config.msg) ? config.msg : "") + "</p></div>";
