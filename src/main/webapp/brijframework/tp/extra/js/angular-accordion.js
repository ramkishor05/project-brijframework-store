angular.module('angular-accordion', [])
        ...
        return {
            ...
            controller: ['$scope', function($scope) {
                ...
                this.getHeaderClass = function(){
                    return $scope.headerClass;
                };
                 this.getContentClass = function(){
                    return $scope.contentClass;
                };
                this.getExpandedValue = function(){
                    return $scope.expandedValue();
                }
            }],
            scope: {
                headerClass :'@',
    ...
    .directive('paneHeader', ['$window', 'Debounce', function($window, Debounce) {
        return {
            ...
            link: function(scope, iElement, iAttrs, controller) {
                if(controller.getExpandedValue()){
                    scope.expanded = controller.getExpandedValue();
                }else{
                ...
                scope.accordianclass = iAttrs.accordianclass;
                controller.addPane(scope);
                scope.headerClass = controller.getHeaderClass();
                scope.contentClass = controller.getContentClass();
            ...
            template: '<div ng-transclude class="angular-accordion-header {{headerClass}}" ng-click="toggle()" ' +
    ...
    .directive('paneContent', function() {
        return {
            ...
            transclude: true,
            replace: true,
            template: '<div ng-transclude class="angular-accordion-pane-content {{contentClass}}" ng-show="expanded"></div>'
        };
    })
