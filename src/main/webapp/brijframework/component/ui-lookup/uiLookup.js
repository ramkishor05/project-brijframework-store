webApp.directive('uiLookup',function(ajaxServices,metaDataServices,dateUtil){
	return{
        restrict:"EA",
        scope:{
        	id:'@',
        ...
        replace:true,
        templateUrl:"brijframework/component/ui-lookup/uiLookup.html",
        link:function(scope,element,attr){
        	...
        	scope.fillUIMetaData=function(metaData){
	        	...
	        	scope.displayKey=attr.displayKey!=undefined?attr.displayKey:metaData.displayKey;
        	}
        	...
        	function startup(){
        		var lookup=metaDataServices.lookupHashForID(scope.id);
	        	if(lookup!=null||lookup!=undefined){
	        		scope.fillUIMetaData(lookup)
        			scope.loadData();
